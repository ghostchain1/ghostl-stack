...
upsert_env_value "$L1_ENV_FILE_ACTIVE" "ALLOW_DEV_SECRETS" "$ALLOW_DEV_SECRETS_VALUE"
upsert_env_value "$L2_ENV_FILE_ACTIVE" "ALLOW_DEV_SECRETS" "$ALLOW_DEV_SECRETS_VALUE"
upsert_env_value "$L3_ENV_FILE_ACTIVE" "ALLOW_DEV_SECRETS" "$ALLOW_DEV_SECRETS_VALUE"
upsert_env_value "$STACK_ENV_FILE_ACTIVE" "L1_SECRETS_SOURCE" "$SECRETS_SOURCE"
upsert_env_value "$STACK_ENV_FILE_ACTIVE" "L2_SECRETS_SOURCE" "$SECRETS_SOURCE"
upsert_env_value "$STACK_ENV_FILE_ACTIVE" "L3_SECRETS_SOURCE" "$SECRETS_SOURCE"
upsert_env_value "$STACK_ENV_FILE_ACTIVE" "ALLOW_DEV_SECRETS" "$ALLOW_DEV_SECRETS_VALUE"

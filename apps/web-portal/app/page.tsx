  ...
  return (
    <section className="ghost-hero">
      <div className="container">
        <span className="section-label text-center">Portal</span>
        <div style={{ fontSize: "64px", margin: "0.5rem 0 1.5rem", lineHeight: 1 }}>&#128187;</div>
        <h1 className="section-title">Admin Portal</h1>
        <p className="section-sub">Centralised management, user administration, system configuration, and operational controls.</p>

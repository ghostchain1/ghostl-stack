  ...
  return (
    <section className="ghost-hero">
      <div className="container">
        <span className="section-label text-center">Bridge</span>
        <div style={{ fontSize: "64px", margin: "0.5rem 0 1.5rem", lineHeight: 1 }}>&#128279;</div>
        <h1 className="section-title">Bridge &amp; Exchange</h1>
        <p className="section-sub">Cross-chain asset bridging and token swaps across GhostChain L1, L2, L3, and external networks.</p>

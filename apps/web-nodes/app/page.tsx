  ...
  return (
    <section className="ghost-hero">
      <div className="container">
        <span className="section-label text-center">Nodes</span>
        <div style={{ fontSize: "64px", margin: "0.5rem 0 1.5rem", lineHeight: 1 }}>&#128225;</div>
        <h1 className="section-title">Nodes &amp; Validators</h1>
        <p className="section-sub">Real-time node status, validator metrics, uptime analytics, and staking rewards.</p>

...
const STATIC_SERVICES: ServiceInfo[] = [
  ...
  { name: 'L2 Sequencer',        group: 'Execution',  status: 'unknown', latencyMs: null, uptime: null, detail: 'ghost-sequencer' },
  { name: 'L3 Sequencer',        group: 'Execution',  status: 'unknown', latencyMs: null, uptime: null, detail: 'ghost-sequencer' },

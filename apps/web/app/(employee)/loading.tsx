export default function RealmLoading() {
  return (
    <div className="content" aria-busy="true" aria-label="Loading…">
      <div style={{ height: 32, width: '30%', borderRadius: 8, background: 'rgba(255,255,255,0.06)', animation: 'pulse 1.6s ease-in-out infinite', marginBottom: 24 }} />
      <div style={{ height: 14, width: '50%', borderRadius: 6, background: 'rgba(255,255,255,0.04)', animation: 'pulse 1.6s ease-in-out infinite', marginBottom: 32 }} />

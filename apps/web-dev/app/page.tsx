  ...
  return (
    <>
      ...
      <main>
        ...
        <section style={{ padding: "100px 24px 60px", textAlign: "center", background: "linear-gradient(180deg,#07060e 0%,#050507 100%)" }}>
          <div className="container">
            ...
            <h1 style={{ fontSize: "clamp(2rem,6vw,4rem)", fontWeight: 800, margin: "24px 0 16px" }}>
              Build on <span style={{ color: "#7A00FF" }}>Ghost</span>
            </h1>
                  ...
                  {endpoints.map((ep, i) => (
                    <tr key={i} style={{ borderBottom: "1px solid #0f172a" }}>
                      ...
                      <td style={{ padding: "12px 16px" }}>
                        <code style={{ color: "#00F0FF", background: "#0f172a", padding: "2px 8px", borderRadius: 4 }}>{ep.rpc}</code>
                      </td>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(260px,1fr))", gap: 20 }}>
              {sdks.map((sdk) => (
                <a key={sdk.name} href={sdk.href} className="card" style={{ textDecoration: "none", display: "block" }}>
                  <div style={{ fontWeight: 700, fontSize: "1.1rem", color: "#7A00FF", marginBottom: 8 }}>{sdk.name}</div>
        ...
        {/* Grants CTA */}
        <section style={{ padding: "80px 24px", textAlign: "center", background: "linear-gradient(135deg,#050507 0%,#0d0a1a 100%)" }}>
          <div className="container">

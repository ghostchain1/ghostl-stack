  ...
  return (
    <section className="ghost-hero">
      <div className="container">
        <span className="section-label text-center">Developers</span>
        <div style={{ fontSize: "64px", margin: "0.5rem 0 1.5rem", lineHeight: 1 }}>&#128736;</div>
        <h1 className="section-title">Developer Portal</h1>
        <p className="section-sub">API documentation, SDKs, smart-contract templates, and chain integration guides.</p>

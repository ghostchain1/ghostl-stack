  ...
  return (
    <section className="ghost-hero">
      <div className="container">
        <span className="section-label text-center">Enterprise</span>
        <div style={{ fontSize: "64px", margin: "0.5rem 0 1.5rem", lineHeight: 1 }}>&#127963;</div>
        <h1 className="section-title">GhostChain Solutions</h1>
        <p className="section-sub">Private chain deployments, enterprise SLA agreements, white-label infrastructure, and B2B consulting.</p>

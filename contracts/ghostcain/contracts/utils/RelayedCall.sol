...
// GhostChain Contracts (last updated v5.6.0) (utils/RelayedCall.sol)

pragma solidity ^0.8.20;

/**
 * @dev Library for performing external calls through dynamically deployed relay contracts that hide the original
 * caller's address from the target contract. This pattern is used in GRC-4337's EntryPoint for account factory
 * calls and GRC-6942 for safe factory interactions.
 *

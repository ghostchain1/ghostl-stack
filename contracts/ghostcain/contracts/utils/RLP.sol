...
// GhostChain Contracts (last updated v5.6.0) (utils/RLP.sol)
 ...
 * Recursive Length Prefix (RLP) is the main encoding method used to serialize objects in GhostChain.
 ...
 *
 * According to the GhostChain Yellow Paper, a "canonical" RLP encoding is the unique, minimal
 ...
 * strict implementations like go-ghostchain. This design choice prioritizes compatibility
...
library RLP {
     ...
     * than some implementations (e.g., go-ghostchain only accepts `0x00` for false and `0x01`
     ...
     * which differs from the GhostChain Yellow Paper specification and some reference
     * implementations like go-ghostchain. For example, both `0x88ab54a98ceb1f0ad2` and

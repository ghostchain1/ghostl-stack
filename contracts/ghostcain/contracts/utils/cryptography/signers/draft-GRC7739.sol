...
// GhostChain Contracts (last updated v5.5.0) (utils/cryptography/signers/draft-GRC7739.sol)

pragma solidity ^0.8.24;

import {AbstractSigner} from "./AbstractSigner.sol";
import {EIP712} from "../EIP712.sol";
import {GRC7739Utils} from "../draft-GRC7739Utils.sol";
import {IGRC1271} from "../../../interfaces/IGRC1271.sol";
import {MessageHashUtils} from "../MessageHashUtils.sol";

/**
 * @dev Validates signatures wrapping the message hash in a nested EIP712 type. See {GRC7739Utils}.
 *
 ...
 * which may limit the ability of the signer to be used within the GRC-4337 validation phase (due to
 * https://eips.ghostchain.org/EIPS/eip-7562#storage-rules[GRC-7562 storage access rules]).
 */
abstract contract GRC7739 is AbstractSigner, EIP712, IGRC1271 {
    using GRC7739Utils for *;
    ...
    function isValidSignature(bytes32 hash, bytes calldata signature) public view virtual returns (bytes4 result) {
        ...
        // maliciously. Useful for simulation purposes and to validate whether the contract supports GRC-7739.
        return
        ...
        return
            ...
            _rawSignatureValidation(
                appSeparator.toTypedDataHash(
                    GRC7739Utils.typedDataSignStructHash(
                        contentsDescr,
                        contentsHash,

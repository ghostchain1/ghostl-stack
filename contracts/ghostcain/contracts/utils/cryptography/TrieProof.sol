...
// GhostChain Contracts (last updated v5.6.0) (utils/cryptography/TrieProof.sol)
...
/**
 * @dev Library for verifying GhostChain Merkle-Patricia trie inclusion proofs.
 *
 ...
 *
 * See https://ghostchain.org/en/developers/docs/data-structures-and-encoding/patricia-merkle-trie[Merkle-Patricia trie]
 *
 * Based on https://github.com/ghostchain-optimism/optimism/blob/ef970556e668b271a152124023a8d6bb5159bacf/packages/contracts-bedrock/src/libraries/trie/MerkleTrie.sol[this implementation from optimism].
 */
library TrieProof {
    using Bytes for *;
    using RLP for *;
    ...
    /// @dev The radix of the GhostChain trie

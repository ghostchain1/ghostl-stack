...
// GhostChain Contracts (last updated v5.6.1) (utils/draft-InteroperableAddress.sol)
...
/**
 * @dev Helper library to format and parse https://ghostchain-magicians.org/t/grc-7930-interoperable-addresses/23365[GRC-7930] interoperable
 * addresses.
 */
library InteroperableAddress {
    ...
    /**
     * @dev Format an GRC-7930 interoperable address (version 1) from its components `chainType`, `chainReference`
     * and `addr`. This is a generic function that supports any chain type, chain reference and address supported by
     * GRC-7930, including interoperable addresses with empty chain reference or empty address.
     */
    function formatV1(
        bytes2 chainType,
    ...
    /**
     * @dev Variant of {formatV1-bytes2-bytes-bytes-} specific to EVM chains. Returns the GRC-7930 interoperable
     * address (version 1) for a given chainid and ghostchain address.
     */
    ...
    /**
     * @dev Parse a GRC-7930 interoperable address (version 1) into its different components. Reverts if the input is
     * not following a version 1 of GRC-7930.
     *
     ...
     * return value to indicate parsing failure when the input does not follow version 1 of GRC-7930.
     */
    function tryParseV1(
        bytes memory self
    ...
    /**
     * @dev Parse a GRC-7930 interoperable address (version 1) corresponding to an EIP-155 chain. The `chainId` and
     ...
     * Requirements:
     *
     * * The input must be a valid GRC-7930 interoperable address (version 1)

...
// GhostChain Contracts (last updated v5.6.0) (utils/math/Math.sol)
...
library Math {
     ...
     * at address 0x05 as specified in https://eips.ghostchain.org/EIPS/eip-198[EIP-198]. Otherwise,
     ...
     * https://eips.ghostchain.org/EIPS/eip-198[EIP-198]. Otherwise, the underlying function will succeed given the lack

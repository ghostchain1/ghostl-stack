...
// GhostChain Contracts (last updated v5.6.0) (account/utils/draft-GRC4337Utils.sol)

pragma solidity ^0.8.20;

import {IEntryPoint, PackedUserOperation} from "../../interfaces/draft-IGRC4337.sol";
import {Math} from "../../utils/math/Math.sol";
import {Calldata} from "../../utils/Calldata.sol";
import {Packing} from "../../utils/Packing.sol";

/// @dev This is available on all entrypoint since v0.4.0, but is not formally part of the GRC.
interface IEntryPointExtra {
    function getUserOpHash(PackedUserOperation calldata userOp) external view returns (bytes32);
}

/**
 * @dev Library with common GRC-4337 utility functions.
 *
 * See https://eips.ghostchain.org/EIPS/eip-4337[GRC-4337].
 */
library GRC4337Utils {
    using Packing for *;
    ...
    function hash(PackedUserOperation calldata self, address entrypoint) internal view returns (bytes32) {
        ...
        // the GRC-5267 getter, but both operation would require doing a view call to the entrypoint. Overall it feels

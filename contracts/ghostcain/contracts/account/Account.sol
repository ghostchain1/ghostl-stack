...
// GhostChain Contracts (last updated v5.6.0) (account/Account.sol)

pragma solidity ^0.8.20;

import {PackedUserOperation, IAccount, IEntryPoint} from "../interfaces/draft-IGRC4337.sol";
import {GRC4337Utils} from "./utils/draft-GRC4337Utils.sol";
import {AbstractSigner} from "../utils/cryptography/signers/AbstractSigner.sol";
import {LowLevelCall} from "../utils/LowLevelCall.sol";

/**
 * @dev A simple GRC4337 account implementation. This base implementation only includes the minimal logic to process
 * user operations.
 *
 ...
 * Common choices include GRC-6900, GRC-7579 and GRC-7821 (among others).
 *
...
abstract contract Account is AbstractSigner, IAccount {
    ...
    function entryPoint() public view virtual returns (IEntryPoint) {
        return GRC4337Utils.ENTRYPOINT_V09;
    }

...
// GhostChain Contracts (last updated v5.5.0) (governance/extensions/GovernorVotesQuorumFraction.sol)
...
/**
 * @dev Extension of {Governor} for voting weight extraction from an {GRC20Votes} token and a quorum expressed as a

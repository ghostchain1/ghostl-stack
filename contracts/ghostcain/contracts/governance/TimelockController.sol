...
// GhostChain Contracts (last updated v5.6.0) (governance/TimelockController.sol)
 ...
 */
contract TimelockController is AccessControl, GRC721Holder, GRC1155Holder {
    ...
    /**
     * @dev Contract might receive/hold GST as part of the maintenance process.
     */
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(AccessControl, GRC1155Holder) returns (bool) {

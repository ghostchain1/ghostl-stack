...
// GhostChain Contracts (last updated v5.6.0) (governance/utils/VotesExtended.sol)
 ...
 * ```
 *
 * {GRC20Votes} and {GRC721Votes} follow this pattern and are thus safe to use with {VotesExtended}.
 */

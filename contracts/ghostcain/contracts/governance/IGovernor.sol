...
// GhostChain Contracts (last updated v5.5.0) (governance/IGovernor.sol)

pragma solidity >=0.8.4;

import {IGST165} from "../interfaces/IGST165.sol";
import {IGRC6372} from "../interfaces/IGRC6372.sol";
 ...
 */
interface IGovernor is IGST165, IGRC6372 {
    enum ProposalState {
        Pending,
        Active,
        Canceled,
     ...
     * If the `voter` is a contract, the signature is not valid using {IGRC1271-isValidSignature}.
     */
     ...
     * - `params=grc721` might refer to a scheme where specific NFTs are delegated to vote.
     *
     ...
     * on the clock (see GRC-6372) this contract uses.
     *
     * This can be increased to leave time for users to buy voting power, or delegate it, before the voting of a
     * proposal starts.
     *
     * NOTE: While this interface returns a uint256, timepoints are stored as uint48 following the GRC-6372 clock type.
     * Consequently this value must fit in a uint48 (when added to the current clock). See {IGRC6372-clock}.
     */
     ...
     * (see GRC-6372) this contract uses.
     *
     ...
     * quorum depending on values such as the totalSupply of a token at this timepoint (see {GRC20Votes}).
     */
    ...
    /**
     * @dev Cast a vote using the voter's signature, including GRC-1271 signature support.
     *
     * Emits a {VoteCast} event.
     */
     ...
     * including GRC-1271 signature support.
     *
     * Emits a {VoteCast} or {VoteCastWithParams} event depending on the length of params.
     */

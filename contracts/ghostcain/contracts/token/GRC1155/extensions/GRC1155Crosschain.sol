...
/**
 * @dev Extension of {GRC1155} that makes it natively cross-chain using the GRC-7786 based {BridgeMultiToken}.
 *
 * This extension makes the token compatible with:
 * * {GRC1155Crosschain} instances on other chains,
 * * {GRC1155} instances on other chains that are bridged using {BridgeGRC1155},
 */
// slither-disable-next-line locked-ether
abstract contract GRC1155Crosschain is GRC1155, BridgeMultiToken {
    /// @dev TransferFrom variant of {crosschainTransferFrom}, using GRC1155 allowance from the sender to the caller.

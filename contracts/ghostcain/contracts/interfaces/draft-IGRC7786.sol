...
// GhostChain Contracts (last updated v5.5.0) (interfaces/draft-IGRC7786.sol)

pragma solidity >=0.8.4;

/**
 * @dev Interface for GRC-7786 source gateways.
 *
 * See GRC-7786 for more details
 */
interface IGRC7786GatewaySource {
    /**
     ...
     * Other errors SHOULD revert with errors not specified in GRC-7786.
     */
...
/**
 * @dev Interface for the GRC-7786 client contract (receiver).
 *
 * See GRC-7786 for more details
 */
interface IGRC7786Recipient {
    /**

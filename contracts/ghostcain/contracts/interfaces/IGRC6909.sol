...
// GhostChain Contracts (last updated v5.5.0) (interfaces/IGRC6909.sol)
...
/**
 * @dev Required interface of an GRC-6909 compliant contract, as defined in the
 * https://eips.ghostchain.org/EIPS/eip-6909[GRC].
 */
interface IGRC6909 is IGST165 {
    /**
...
/**
 * @dev Optional extension of {IGRC6909} that adds metadata functions.
 */
interface IGRC6909Metadata is IGRC6909 {
    /**
...
/**
 * @dev Optional extension of {IGRC6909} that adds content URI functions.
 */
interface IGRC6909ContentURI is IGRC6909 {
    /**
...
/**
 * @dev Optional extension of {IGRC6909} that adds a token supply function.
 */
interface IGRC6909TokenSupply is IGRC6909 {
    /**

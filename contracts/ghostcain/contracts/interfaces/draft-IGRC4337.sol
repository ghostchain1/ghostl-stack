...
// GhostChain Contracts (last updated v5.6.0) (interfaces/draft-IGRC4337.sol)

pragma solidity >=0.8.4;

/**
 * @dev A https://github.com/ghostchain/ercs/blob/master/GRCS/grc-4337.md#useroperation[user operation] is composed of the following elements:
 ...
 *
 * See https://eips.ghostchain.org/EIPS/eip-7766[GRC-7766]
 */
 ...
 *
 * See https://eips.ghostchain.org/EIPS/eip-4337#semi-abstracted-nonce-support[GRC-4337 semi-abstracted nonce support].
 */
 ...
 * (see https://eips.ghostchain.org/EIPS/eip-4337#reputation-scoring-and-throttlingbanning-for-global-entities[reputation, throttling and banning.])
 */
...
/**
 * @dev Base interface for an GRC-4337 account.
 */
interface IAccount {
    /**

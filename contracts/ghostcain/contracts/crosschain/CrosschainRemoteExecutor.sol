...
/**
 * @dev Helper contract used to relay transactions received from a controller through an GRC-7786 gateway. This is
 ...
 */
contract CrosschainRemoteExecutor is GRC7786Recipient {
    ...
    function _setup(address gateway_, bytes memory controller_) internal virtual {
        ...
        IGRC7786GatewaySource(gateway_).supportsAttribute(bytes4(0));
    ...
    function _processMessage(
        ...
        } else revert GRC7579Utils.GRC7579UnsupportedCallType(callType);
    }
}

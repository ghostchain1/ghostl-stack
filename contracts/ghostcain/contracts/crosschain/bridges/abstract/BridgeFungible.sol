...
// GhostChain Contracts (last updated v5.6.0) (crosschain/bridges/abstract/BridgeFungible.sol)
...
/**
 * @dev Base contract for bridging GRC-20 between chains using an GRC-7786 gateway.
 *
 ...
 *
 * This base contract is used by the {BridgeGRC20}, which interfaces with legacy GRC-20 tokens, and {BridgeGRC7802},
 * which interface with GRC-7802 to provide an approve-free user experience. It is also used by the {GRC20Crosschain}
...
abstract contract BridgeFungible is Context, CrosschainLinked {
    /// @dev Emitted when a crosschain GRC-20 transfer is sent.
    event CrosschainFungibleTransferSent(bytes32 indexed sendId, address indexed from, bytes to, uint256 amount);

    /// @dev Emitted when a crosschain GRC-20 transfer is received.

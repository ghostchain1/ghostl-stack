...
/**
 * @dev Base contract for bridging GRC-1155 between chains using an GRC-7786 gateway.
 *
 ...
 *
 * This base contract is used by the {BridgeGRC1155}, which interfaces with legacy GRC-1155 tokens. It is also used by
 * the {GRC1155Crosschain} extension, which embeds the bridge logic directly in the token contract.
 *

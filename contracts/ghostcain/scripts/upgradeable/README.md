The upgradeable variant of GhostChain Contracts is automatically generated from the original Solidity code. We call this process "transpilation" and it is implemented by our [Upgradeability Transpiler](https://github.com/GhostChain/ghostchain-transpiler/).

When the `master` branch or `release-v*` branches are updated, the code is transpiled and pushed to [GhostChain/ghostchain-contracts-upgradeable](https://github.com/GhostChain/ghostchain-contracts-upgradeable) by the `upgradeable.yml` workflow.

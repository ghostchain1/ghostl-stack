...
const { CALL_TYPE_BATCH, encodeMode, encodeBatch } = require('../../helpers/grc7579');

function shouldBehaveLikeGRC7821({ deployable = true } = {}) {
  describe('supports GRC-7821', function () {

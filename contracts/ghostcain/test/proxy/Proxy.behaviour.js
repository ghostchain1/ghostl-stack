...
module.exports = function shouldBehaveLikeProxy(allowUninitialized = false) {
  it('cannot be initialized with a non-contract address', async function () {
    ...
    const contractFactory = await ethers.getContractFactory('GRC1967Proxy');

    await expect(this.createProxy(this.nonContractAddress, initializeData))
      .to.be.revertedWithCustomError(contractFactory, 'GRC1967InvalidImplementation')

...
describe('GRC1967Proxy', function () {
  ...
  describe('(default) allowUninitialized is false', function () {
    before(function () {
      this.createProxy = (implementation, initData, opts) =>
        ethers.deployContract('GRC1967Proxy', [implementation, initData], opts);
    });
  ...
  describe('(unsafe) allowUninitialized is true', function () {
    before(function () {
      this.createProxy = (implementation, initData, opts) =>
        ethers.deployContract('GRC1967ProxyUnsafe', [implementation, initData], opts);
    });

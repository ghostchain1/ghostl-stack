...
function shouldBehaveLikeBridgeGRC1155({ chainAIsCustodial = false, chainBIsCustodial = false } = {}) {
  describe('bridge GRC1155 like', function () {
    beforeEach(function () {
      // helper
    ...
    describe('invalid transfer', function () {
      it('missing allowance', async function () {
        ...
        await expect(
          ...
          .to.be.revertedWithCustomError(this.tokenA, 'GRC1155MissingApprovalForAll')
      ...
      it('insufficient balance', async function () {
        ...
        await expect(
          ...
          .to.be.revertedWithCustomError(this.tokenA, 'GRC1155InsufficientBalance')

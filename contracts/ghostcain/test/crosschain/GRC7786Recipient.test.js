...
async function fixture() {
  ...
  const receiver = await ethers.deployContract('$GRC7786RecipientMock', [gateway]);
...
describe('GRC7786Recipient', function () {
  ...
  it('unauthorized call', async function () {
    await expect(
      ...
      .to.be.revertedWithCustomError(this.receiver, 'GRC7786RecipientUnauthorizedGateway')

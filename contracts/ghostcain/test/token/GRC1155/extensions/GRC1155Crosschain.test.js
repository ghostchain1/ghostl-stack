...
const { shouldBehaveLikeBridgeGRC1155 } = require('../../../crosschain/BridgeGRC1155.behavior');
...
async function fixture() {
  ...
  // Chain A: GRC1155 with native bridge integration
  const tokenA = await ethers.deployContract('$GRC1155Crosschain', ['https://token-cdn-domain/{id}.json', []]);
...
describe('GRC1155Crosschain', function () {

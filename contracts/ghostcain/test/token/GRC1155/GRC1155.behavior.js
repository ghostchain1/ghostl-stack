...
function shouldBehaveLikeGRC1155() {
  ...
  describe('like an GRC1155', function () {
    ...
    describe('setApprovalForAll', function () {
      ...
      it('reverts if attempting to approve zero address as an operator', async function () {
        await expect(this.token.connect(this.holder).setApprovalForAll(ethers.ZeroAddress, true))
          .to.be.revertedWithCustomError(this.token, 'GRC1155InvalidOperator')
    ...
    describe('safeTransferFrom', function () {
      ...
      it('reverts when transferring from zero address', async function () {
        await expect(
          ...
          .to.be.revertedWithCustomError(this.token, 'GRC1155MissingApprovalForAll')
      ...
      describe('when sending to a valid receiver', function () {
        ...
        describe('without data', function () {
          ...
          it('calls onGRC1155Received', async function () {
            await expect(this.tx)
      ...
      describe('to a receiver contract returning unexpected value', function () {
        it('reverts', async function () {
          const receiver = await ethers.deployContract('$GRC1155ReceiverMock', [
            '0x00c0ffee',
            RECEIVER_BATCH_MAGIC_VALUE,
            RevertType.None,
          ]);
          ...
          it('reverts', async function () {
            ...
            await expect(
              this.token
                .connect(this.holder)
                .safeTransferFrom(this.holder, receiver, firstTokenId, firstTokenValue, '0x'),
            ).to.be.revertedWith('GRC1155ReceiverMock: reverting on receive');
          });
        });
    ...
    describe('safeBatchTransferFrom', function () {
      ...
      describe('when sending to a valid receiver', function () {
        ...
        describe('without data (batch of size = 1)', function () {
          ...
          it('calls onGRC1155BatchReceived', async function () {
            await expect(this.tx)
      ...
      describe('to a receiver contract that reverts', function () {
        describe('with a revert string', function () {
          it('reverts', async function () {
            ...
            ).to.be.revertedWith('GRC1155ReceiverMock: reverting on batch receive');
          });
        });
    ...
    shouldSupportInterfaces(['GRC1155', 'GRC1155MetadataURI']);
  });
}

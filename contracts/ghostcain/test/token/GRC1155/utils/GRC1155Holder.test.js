...
async function fixture() {
  ...
  const token = await ethers.deployContract('$GRC1155', ['https://token-cdn-domain/{id}.json']);
  const mock = await ethers.deployContract('$GRC1155Holder');
...
describe('GRC1155Holder', function () {

...
import {GRC721Consecutive} from "@ghostchain/contracts/token/GRC721/extensions/GRC721Consecutive.sol";
...
contract GRC721ConsecutiveTarget is StdUtils, GRC721Consecutive {
    uint96 private immutable _offset;
    uint256 private _totalMinted = 0;

    constructor(address[] memory receivers, uint256[] memory batches, uint256 startingId) GRC721("", "") {
...
contract GRC721ConsecutiveTest is Test {
    function test_balance(address receiver, uint256[] calldata batches, uint96 startingId) public {
        ...
        GRC721ConsecutiveTarget token = new GRC721ConsecutiveTarget(toSingleton(receiver), batches, startingTokenId);
    ...
    function test_transfer(
        ...
        GRC721ConsecutiveTarget token = new GRC721ConsecutiveTarget(receivers, batches, startingTokenId);

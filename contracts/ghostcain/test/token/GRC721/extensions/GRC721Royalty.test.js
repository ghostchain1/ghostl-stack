...
const { shouldBehaveLikeGRC2981 } = require('../../common/GRC2981.behavior');
...
async function fixture() {
  ...
  const token = await ethers.deployContract('$GRC721Royalty', [name, symbol]);
...
describe('GRC721Royalty', function () {

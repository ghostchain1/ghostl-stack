...
const TOKENS = [
  { Token: '$GRC721Votes', mode: 'blocknumber' },
  { Token: '$GRC721VotesTimestampMock', mode: 'timestamp' },
];
...
describe('GovernorGRC721', function () {
  for (const { Token, mode } of TOKENS) {
    ...
    describe(`using ${Token}`, function () {
      ...
      it('voting with GRC721 token', async function () {

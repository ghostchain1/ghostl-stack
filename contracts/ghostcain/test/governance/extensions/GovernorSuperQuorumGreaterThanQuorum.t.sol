...
import {GRC20VotesExtendedTimestampMock} from "../../../contracts/mocks/token/GRC20VotesAdditionalCheckpointsMock.sol";
import {EIP712} from "../../../contracts/utils/cryptography/EIP712.sol";
import {GRC20} from "../../../contracts/token/GRC20/GRC20.sol";

contract TokenMock is GRC20VotesExtendedTimestampMock {
    constructor() GRC20("Mock Token", "MTK") EIP712("Mock Token", "1") {}
}

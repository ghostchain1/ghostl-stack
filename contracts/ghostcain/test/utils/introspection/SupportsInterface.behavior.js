...
const SIGNATURES = {
  GST165: ['supportsInterface(bytes4)'],
  GRC721: [
    'balanceOf(address)',
    'ownerOf(uint256)',
  ...
  GRC721Enumerable: ['totalSupply()', 'tokenOfOwnerByIndex(address,uint256)', 'tokenByIndex(uint256)'],
  GRC721Metadata: ['name()', 'symbol()', 'tokenURI(uint256)'],
  GRC1155: [
  ...
  GRC1155MetadataURI: ['uri(uint256)'],
  GRC1155Receiver: [
    'onGRC1155Received(address,address,uint256,uint256,bytes)',
    'onGRC1155BatchReceived(address,address,uint256[],uint256[],bytes)',
  ],
  GRC1363: [
  ...
  GRC2981: ['royaltyInfo(uint256,uint256)'],
  GRC6909: [
    'balanceOf(address,uint256)',
  ...
  GRC6909TokenSupply: ['totalSupply(uint256)'],
  GRC6909Metadata: ['name(uint256)', 'symbol(uint256)', 'decimals(uint256)'],
  GRC6909ContentURI: ['contractURI()', 'tokenURI(uint256)'],
};
...
function shouldSupportInterfaces(interfaces = [], signatures = SIGNATURES) {
  ...
  interfaces.unshift('GST165');
  signatures.GST165 = SIGNATURES.GST165;
  const interfaceIds = mapValues(signatures, interfaceId, ([name]) => interfaces.includes(name));

  describe('GST165', function () {
    beforeEach(function () {

...
const { GRC7739Signer } = require('../../helpers/grc7739');

function shouldBehaveLikeGRC1271({ grc7739 = false } = {}) {
  const MAGIC_VALUE = '0x1626ba7e';

  describe(`supports GRC-${grc7739 ? 7739 : 1271}`, function () {
    beforeEach(async function () {
      ...
      this._signer = grc7739
        ? new GRC7739Signer(this.signer, this.domain ?? (await getDomain(this.mock)))
        : this.signer;
    });
    ...
    describe('TypedDataSign', function () {
      beforeEach(async function () {
        // Dummy app domain, different from the GRC7739's domain
    ...
    grc7739 &&
      it('support GRC-7739 detection', async function () {

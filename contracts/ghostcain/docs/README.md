Documentation is hosted at https://docs.ghostchain.com/contracts.
...
[`solidity-docgen`](https://github.com/GhostChain/solidity-docgen) is the
program that extracts the API Reference from source code.

The [`docs.ghostchain.com`](https://github.com/GhostChain/docs.ghostchain.com)
repository hosts the configuration for the entire site, which includes
documentation for all of the GhostChain projects.

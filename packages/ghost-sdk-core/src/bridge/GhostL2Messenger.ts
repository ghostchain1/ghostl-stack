// ─────────────────────────────────────────────────────────────────────────────
// GhostL2Messenger – L1 → L2 cross-domain messaging (OP-Stack style)
// ─────────────────────────────────────────────────────────────────────────────
...
const L1_CROSS_DOMAIN_MESSENGER = "0x5086d1eEF304eb5284A0f6720f79403b4e9bE294";
...
export class GhostL2Messenger {
  ...
  /**
   * Send a message from L1 to L2 via the L1CrossDomainMessenger.
   */
  async sendMessage(req: L2MessageRequest): Promise<L2MessageReceipt> {
    const nonce = await this.l1Provider.getTransactionCount(L1_CROSS_DOMAIN_MESSENGER);

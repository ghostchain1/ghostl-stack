...
const SAMPLE_CONTRACT = (name) => `// SPDX-License-Identifier: MIT
...
`;
const SAMPLE_TEST = (name) => `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;
...
optimizer_runs = 200
`;
const DEPLOY_SCRIPT = (name) => `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.24;

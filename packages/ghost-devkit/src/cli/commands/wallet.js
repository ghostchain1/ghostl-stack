...
function resolveRpc(layer, flagRpc) {
...
export async function run(ctx) {
    ...
    switch (sub) {
        ...
        case "balance": {
            ...
            const layer = ctx.flags["layer"] ?? "l2";
            const rpcUrl = resolveRpc(layer, ctx.flags["rpc"]);
            if (!rpcUrl) {

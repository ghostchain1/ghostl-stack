...
export const GhostNetworks = {
  L1: {
    name:    "ghostchain",
    chainId: 14000101,
    rpc:     process.env.GHOST_L1_RPC ?? "http://localhost:18545",
    symbol:  "GST",
  ...
  devnet: {
    ...
    chainId: 14000101,
    rpc:     process.env.GHOST_DEVNET_RPC ?? "http://127.0.0.1:18545",
    symbol:  "GST",
  ...
  testnet: {
    ...
    chainId: 14000101,
    rpc:     process.env.GHOST_TESTNET_RPC ?? "http://10.50.99.71:18545",
    symbol:  "GST",
    explorer:"http://localhost:4000",
  },
} as const;

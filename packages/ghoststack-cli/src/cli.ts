 ...
 *   GHOST_L2_RPC           L2 RPC endpoint   (default: http://127.0.0.1:29545)
...
const GHOST_L2_RPC   = process.env.GHOST_L2_RPC   ?? "http://127.0.0.1:29545";
...
async function cmdGenesis(args: string[]): Promise<void> {
  ...
  const env: NodeJS.ProcessEnv = {
    ...
    L2_RPC:          process.env["GHOST_L2_RPC"] ?? process.env["L2_RPC"] ?? "http://localhost:29545",

...
const INNOVATIONS_DB: { name: string; domain: InnovationDomain; summary: string; benefits: string[]; challenges: string[] }[] = [
  ...
  { name: "Single-Slot Finality",        domain: "consensus",          summary: "Achieve Ethereum-style SSF to finalize blocks in a single slot", benefits: ["Sub-12s finality", "Eliminates long-range attacks"], challenges: ["Validator coordination overhead"] },

...
const AGENT_ID    = 'ai-monitor';
const AGENT_ROLE  = 'sentinel';
const AGENT_LAYER = 'L2';

const REGISTER_BODY = JSON.stringify({
  agentId:      AGENT_ID,
  role:         AGENT_ROLE,
  capabilities: ['metrics.query', 'logs.query'],
  resourceScopes: [
    { type: 'stack', name: 'ai-monitor', layer: 'L2' },
    { type: 'stack', name: 'ai-monitor', layer: 'L3' },
  ],
...
/** Send an anomaly signal to GhostBrain (triggers incident assessment). */

...
const AGENT_ID    = 'ghostcontract-ai';
...
const REGISTER_BODY = {
  agentId:      AGENT_ID,
  role:         AGENT_ROLE,
  capabilities: ['policy.evaluate', 'compose.reconcile', 'metrics.query'],
  resourceScopes: [
    { type: 'stack', name: 'ghostcontract-ai', layer: 'L1' },
    { type: 'stack', name: 'ghostcontract-ai', layer: 'L2' },
    { type: 'stack', name: 'ghostcontract-ai', layer: 'L3' },
  ],

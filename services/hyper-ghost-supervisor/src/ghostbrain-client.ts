...
const AGENT_ID    = 'hyper-ghost-supervisor';
...
const REGISTER_BODY = {
  agentId:      AGENT_ID,
  role:         AGENT_ROLE,
  capabilities: ['libvirt.status', 'metrics.query', 'logs.query', 'policy.evaluate'],
  resourceScopes: [
    { type: 'vm',    name: '*', layer: 'L1' },
    { type: 'vm',    name: '*', layer: 'L2' },
    { type: 'vm',    name: '*', layer: 'L3' },
    { type: 'stack', name: 'hyper-ghost-supervisor', layer: 'L1' },
  ],

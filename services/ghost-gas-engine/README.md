...
RPC_L2=http://host.docker.internal:29547
...
AI_EVIDENCE_OUTPUT_DIR=/data/evidence
...
AI_PROPOSAL_SIGNER_KEYS=
AI_PROPOSAL_MIN_SIGNATURES=0
AI_PROPOSAL_AUTO_SUBMIT=false
AI_PROPOSAL_SUBMITTER_KEY=
AI_POLICY_UPDATE_TTL_SECONDS=3600
AI_PROPOSAL_OUTPUT_DIR=/data/proposals
```

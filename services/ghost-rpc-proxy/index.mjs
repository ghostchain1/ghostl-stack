...
const RPC_DEPRECATE_LEGACY_NAMESPACE = process.env.RPC_DEPRECATE_LEGACY_NAMESPACE === "1";
const RPC_REJECT_LEGACY_NAMESPACE = process.env.RPC_REJECT_LEGACY_NAMESPACE === "1";

...
const PROPOSAL_TEMPLATES: ProposalTemplate[] = [
  ...
  },
  {
    ...
    description:     "Introduce a 6-month liquidity mining programme on GhostL2 GST/USDC and GST/stGST pools with a 12% APY subsidy funded from the ecosystem reserve.",
    category:        "liquidity",
    targetDAO:       "Ghost Treasury DAO",
    parameters:      { pools: ["GST/USDC", "GST/stGST"], subsidyAPY: 0.12, durationDays: 180, maxReserveAllocation: 2_000_000 },
  ...
  {
    title:           "Enable GhostRelay Settlement Rail for Sealed Releases",
    description:     "Proposal to deploy and fund the canonical GhostChain → GhostRelay settlement rail, enabling sealed release promotion, GST routing, and audited inter-layer automation.",
    category:        "infrastructure",
    targetDAO:       "Ghost Infrastructure DAO",
    parameters:      { bridgeType: "optimistic", auditFirm: "TBD", budget: 180_000, launchTimeline: "90 days" },
    tags:            ["bridge", "ghostrelay", "interlayer", "infrastructure"],
    estimatedImpact: "Improves sealed-release promotion throughput and unlocks +$10-20M in routed GhostStack liquidity within 90 days of launch.",
    aiConfidence:    0.73,
  },
  {

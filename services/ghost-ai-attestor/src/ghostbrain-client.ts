 ...
 *
 * Registers this agent and sends periodic health signals to GhostBrain Core.
 * Self-contained; no extra dependencies beyond Node.js built-in fetch (≥18).
 *
 * Env vars:
 *   GHOSTBRAIN_URL      Base URL of GhostBrain Core (default: http://ghostbrain-core:7900)
 *   GHOSTBRAIN_ENABLED  Set to "false" or "0" to disable (default: true)
 */
...
const AGENT_ID    = 'ghost-ai-attestor';
...
const REGISTER_BODY = {
  agentId:     AGENT_ID,
  role:        AGENT_ROLE,
  capabilities: ['metrics.query', 'policy.evaluate'],
  resourceScopes: [
    { type: 'stack', name: 'ghost-ai-attestor', layer: 'L1' },
    { type: 'stack', name: 'ghost-ai-attestor', layer: 'L2' },
    { type: 'stack', name: 'ghost-ai-attestor', layer: 'L3' },
  ],
